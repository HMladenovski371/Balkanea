        ...
        _login_signup: function (body) {
            $('#st-login-form form, #st-login-form-page form', body).on('submit', function (ev) {
                ...
                var form = $(this),
                    ...
                    let close_modal = $('#st-login-form .modal-header .close, #st-login-form-page .modal-header .close');
                    ...
                    if (typeof respon == 'object') {
                        ...
                        if (respon.status == 0)
                            return false;
                                ...
                                if (respon.status == 1 && typeof respon.redirect !== 'undefined'){
                                ...
                                $("#st-login-form input[type='text']").val('');
                                $("#st-login-form input[type='email']").val('');
                                $("#st-login-form input[type='password']").val('');
                                //$('#st-login-form .fcheckbox').removeClass('checkmark');
                                //$('#st-login-form .fcheckbox').removeClass('fcheckbox');
                                $("#st-login-form .fcheckbox").css('::after', { content: 'none' });
                            }    
                        }, 2000);
        //                 if (respon.status == 1) {
        //                     setTimeout(function () {
