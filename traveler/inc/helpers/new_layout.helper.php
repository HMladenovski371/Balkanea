...
class New_Layout_Helper {
    ...
    static function enqueueNewScriptElementor(){
        ...
        if(is_singular('st_hotel') || is_singular('st_tours') || is_singular('st_activity') || is_singular('st_cars') || is_singular('post') || is_singular('st_rental') || is_singular('hotel_room') || is_search() || is_tag() || is_archive() || is_category() ||is_tax() || is_page_template('template-blog.php')){
            ...
            // Room search - Nikola
            wp_enqueue_script('single-hotel-detail', get_template_directory_uri() . '/v3/js/single-hotel-detail.js', ['jquery'], '1.0.0', true);
        ...
        if ($check_enable_map_google === 'on') {
            ...
            // Loading hotels search page - Nikola
            wp_register_script('filter-hotel', get_template_directory_uri() . '/v3/js/filter/mapbox/filter-hotel-mapbox.js', ['jquery'], '1.0.0', true);
            if(is_page_template('template-rental-search.php') || is_singular('st_rental')){
    ...
    static function enqueueNewScript() {
        ...
        if ($check_enable_map_google === 'on') {
            ...
            // - Nikola
            wp_register_script('filter-hotel-js', get_template_directory_uri() . '/v2/js/mapbox/filter-hotel-mapbox.js', ['jquery'], '1.0.0', true);
        ...
        // - Nikola
        wp_enqueue_script('custom-js', get_template_directory_uri() . '/v2/js/custom.js', ['jquery'], '1.0.0', true);
