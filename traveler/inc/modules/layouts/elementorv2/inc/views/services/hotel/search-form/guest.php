    ...
    <ul class="dropdown-menu st-modern-style">
        ...
        <li class="item d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <span class="tooltip-icon" data-toggle="tooltip" data-placement="top" title="Children: 0-12 years old, no extra bed">
                    <i class="fa fa-info-circle" style="font-size: 14px; color: #6c757d; margin-left: 5px;"></i>
                </span>
            </div>
            <div class="select-wrapper">
                <div class="st-number-wrapper d-flex align-items-center justify-content-between">
