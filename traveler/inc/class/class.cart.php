 ...
 * */
    ...
    class STCart {
        ...
        static function init() {
            ...
            add_action('wp_ajax_update_cart_price', [__CLASS__, 'update_cart_price']);
            add_action('wp_ajax_nopriv_update_cart_price', [__CLASS__, 'update_cart_price']);
        ...
        static function update_cart_price() {
            ...
            try {
                ...
                if (get_woocommerce_currency() == "MKD"){
                    WC()->session->set('full_price', $full_price / 61.50);
                    WC()->session->set('daily_room_price', $daily_room_price / 61.50);
                }else{
                    WC()->session->set('full_price', $full_price);
                    WC()->session->set('daily_room_price', $daily_room_price);
                }
                
                error_log("Daily prices: ");
                error_log($daily_room_price);
