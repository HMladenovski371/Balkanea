...
if (!class_exists('TravelHelper')) {
    ...
    class TravelHelper {
         ...
         *
         *
         * https://ohanaone.atlassian.net/browse/BAL-456 - Nikola 02.19.2025
         * */
         static function convert_money( $money = false, $rate = false, $round = true )
        {
            if ( !$money ) $money = 0;
        
            // Set the fixed conversion rate to 61.53
            $current_rate = 61.53;
        ...
        static function format_money($money = false, $need_convert = true, $precision = 0) {
            ...
            $need_convert = $symbol == 'MKD' ? $need_convert = true : $need_convert = false;
