    ...
    public function get()
    {
        try {
            if (!is_string($this->post_name)) {
                echo("post_name must be a string");
                return null;
            }
            ...
            $query = $this->wpdb->prepare(
                "SELECT * FROM " . $this->wpdb->prefix . $this->table . " WHERE post_name = %s",
                $this->post_name
            );
            ...
            if ($this->wpdb->last_error) {
                $this->log->info("DB error: " . $this->wpdb->last_error);
            }
    
            return $result;
        } catch (\Exception $ex) {
            $this->log->info('Caught exception: ' . $ex->getMessage());
            return null;
        }
    }
